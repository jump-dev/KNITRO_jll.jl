...
function get_artifact(data)
    ...
    url = "https://drive.usercontent.google.com/download?id=$(data.id)&export=download&authuser=0&confirm=t&uuid=6bea6527-a909-4efe-a7c2-0ff7da0f8a81&at=APcmpozvpDzcpRBkuE8zlHCVMTTB:1743738795520"
...
function main()
    platforms = [
        (os = "linux", arch = "x86_64", name = "linux-gnu", id = "1uUwCTa-JIUarnh8OEP_siiZ0FUs9A1G9"),
        (os = "macos", arch = "aarch64", name = "apple-darwin", id = "1bgY09o5SNajMLi8tEk4_zqL3d_SkQaBU"),
        (os = "windows", arch = "x86_64", name = "w64-mingw32", id = "1xj1jcms3dVFXw9q6lcc6843ekq9kA2jV"),
    ]
